...
almet_data = (
    ...
    ,(
        ...
        {'id': 21 , 'type': int16,	'saveTrigger': onChange,	'saveAttr': (0.1, 5,),		'name': "Вентиляторы итого",},
        {'id': 22 , 'type': int16,	'saveTrigger': onChange,	'saveAttr': (0.1, 5,),		'name': "Компрессоры итого",},
        {'id': 23 , 'type': int16,	'saveTrigger': onChange,	'saveAttr': (0.1, 5,),		'name': "Маслоохладитель итого",},
        {'id': 24 , 'type': int32,	'saveTrigger': doNotSave,	'saveAttr': (0.1, 5,),		'name': "Резерв1",},
        {'id': 25 , 'type': int32,	'saveTrigger': doNotSave,	'saveAttr': (0.1, 5,),		'name': "Резерв2",},
        {'id': 26 , 'type': int32,	'saveTrigger': doNotSave,	'saveAttr': (0.1, 5,),		'name': "Резерв3",},
        {'id': 27 , 'type': int32,	'saveTrigger': doNotSave,	'saveAttr': (0.1, 5,),		'name': "Резерв4",},
        {'id': 28 , 'type': int32,	'saveTrigger': doNotSave,	'saveAttr': (0.1, 5,),		'name': "Резерв5",},
        {'id': 29 , 'type': int32,	'saveTrigger': onChange,	'saveAttr': (0.1, 5,),		'name': "Вент1",},
        {'id': 30 , 'type': int32,	'saveTrigger': onChange,	'saveAttr': (0.1, 5,),		'name': "Вент2",},
        {'id': 31 , 'type': int32,	'saveTrigger': onChange,	'saveAttr': (0.1, 5,),		'name': "Вент3",},
        {'id': 32 , 'type': int32,	'saveTrigger': onChange,	'saveAttr': (0.1, 5,),		'name': "Вент4",},
        {'id': 33 , 'type': int32,	'saveTrigger': onChange,	'saveAttr': (0.1, 5,),		'name': "Компрессор1",},
        {'id': 34 , 'type': int32,	'saveTrigger': onChange,	'saveAttr': (0.1, 5,),		'name': "Компрессор2",},
        {'id': 35 , 'type': int32,	'saveTrigger': onChange,	'saveAttr': (0.1, 5,),		'name': "Насос1",},
        {'id': 36 , 'type': int32,	'saveTrigger': onChange,	'saveAttr': (0.1, 5,),		'name': "Насос2",},
        {'id': 37 , 'type': int32,	'saveTrigger': onChange,	'saveAttr': (0.1, 5,),		'name': "Компрессор1Вкл",},
        {'id': 38 , 'type': int32,	'saveTrigger': onChange,	'saveAttr': (0.1, 5,),		'name': "Компрессор2Вкл",},
        {'id': 39 , 'type': int32,	'saveTrigger': onChange,	'saveAttr': (0.1, 5,),		'name': "НасосЛюбойВкл",},
        {'id': 40 , 'type': int32,	'saveTrigger': onChange,	'saveAttr': (0.1, 5,),		'name': "ЛюбойКомпрессорВкл",},
        {'id': 41 , 'type': int32,	'saveTrigger': onChange,	'saveAttr': (0.1, 5,),		'name': "ВентМасла1",},
        {'id': 42 , 'type': int32,	'saveTrigger': onChange,	'saveAttr': (0.1, 5,),		'name': "ВентМасла2",},
        {'id': 43 , 'type': int32,	'saveTrigger': onChange,	'saveAttr': (0.1, 5,),		'name': "ВентМасла3",},
        {'id': 44 , 'type': int32,	'saveTrigger': onChange,	'saveAttr': (0.1, 5,),		'name': "Компрессор3",},
