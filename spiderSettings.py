...
almet_data = (
    ...
    ,(
        ...
        {'id': 26 , 'type': int16,	'saveTrigger': doNotSave,	'saveAttr': (0.1, 5,),		'name': "Команды1",},
        {'id': 27 , 'type': int16,	'saveTrigger': doNotSave,	'saveAttr': (0.1, 5,),		'name': "Команды2",},
        {'id': 28 , 'type': int16,	'saveTrigger': doNotSave,	'saveAttr': (0.1, 5,),		'name': "Команды3",},
...
grenada_map = (
    (
        ...
        {'id': 27, 'type': flt32,	'saveTrigger': onChange, 'saveAttr': (0.3, 5,),	'name':"SCo_PDS_Рекуперат",	},
        {'id': 28, 'type': flt32,	'saveTrigger': onChange, 'saveAttr': (0.3, 5,),	'name':"SCo_t_(обр_воды2)",	},
        {'id': 29, 'type': flt32,	'saveTrigger': onChange, 'saveAttr': (0.3, 5,),	'name':"SCo_ДR1",	},
        {'id': 30, 'type': flt32,	'saveTrigger': doNotSave,	'name':"SCo_ДR2",	},
        {'id': 31, 'type': flt32,	'saveTrigger': doNotSave,	'name':"SCo_ДR3",	},
        {'id': 32, 'type': flt32,	'saveTrigger': onChange, 'saveAttr': (0.3, 5,),	'name':"SCo_ДR4",	},
        {'id': 33, 'type': flt32,	'saveTrigger': onChange, 'saveAttr': (0.1, 60,),	'name':"SCo_Уставка_t",	},
